...
class ImageDownloader : NSObject {
    ...
    func fromURI(_ uri: String?, completion: @escaping (UIImage) -> Void) {
        ...
        let uriPrefix = "phasset:"
        if uri!.hasPrefix(uriPrefix) {
            let id = uri!.substring(from: uri!.index(uri!.startIndex, offsetBy: uriPrefix.characters.count))
