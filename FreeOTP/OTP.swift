...
public final class OTP : NSObject, KeychainStorable {
    ...
    @objc required public init?(coder aDecoder: NSCoder) {
        ...
        secret = aDecoder.decodeObject(of: NSData.self, forKey: "secret") as Data!
    ...
    public func code(_ counter: Int64) -> String {
        ...
        let arr = UnsafePointer(UnsafePointer<UInt8>(buf).advanced(by:off))
        let msk = UInt32(arr[0]).bigEndian & 0x7fffffff
